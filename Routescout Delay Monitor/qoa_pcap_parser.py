...
num_attack_flows = int((num_flows/4)*(float(arguments[1])/100)) 
        ...
        try:
            ...
            if packet_ts-pre_time >= 15:
                ...
                if count <= 4:
                    ...
                    packA_B[1]=0
                    delayMon.reset()
            elif    packet_ts-pre_time  >= 5 and first_qoa:
                for i in range(num_attack_flows):
                    ...
                    while True:
                        ...
                        if hash_key_range1[0] < hash_key < hash_key_range1[1] and delayMon._get_collisions_(key) > 2:
                            delayMon._insert_(key,packet_ts)
                            break
                print('finish')
                first_qoa = False
